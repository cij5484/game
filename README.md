...
모바일 웹 호드 디펜스의 그레이박스 프로토타입입니다. 현재는 **Milestone 6: Portrait Full-Bleed + Stimpack**까지 구현했습니다. 세로 전장에서 적의 성벽 공격, Marine의 탭 기반 3점사와 두 손가락 탭 Stimpack을 플레이할 수 있습니다.
...
- 두 손가락 탭으로 Stimpack을 사용합니다. BOOST → 1초 CRASH(기본공격 불가) → 2초 RECOVERY(공격속도 점진 회복) → NORMAL을 HUD에서 확인할 수 있습니다. Boost 지속시간/배율은 데이터의 prototype tuning 값을 사용합니다.
