...
> = {
  ...
  missile: {
    ...
    title: "유도 미사일",
    symbol: "↗",
    description: "시간차 3발 일제사격 · 위험 표적 사냥 · 기본 재유도",
    trees: [
      tree(
        "saturation",
        "미사일 포화",
        "⋔",
        "일제사격 발수 증가 · 예약 피해를 고려해 표적 배분",
        ["전장 포화", "미사일 스웜", "서로 다른 적을 광범위하게 사냥"],
        [
          "집중 포화",
          "미사일 살보",
          "강적에 필요한 만큼 집중 · 과잉 피해는 다른 표적으로 분산",
        ],
      ),
      tree(
        "hunter",
        "헌터 킬러",
        "⌖",
        "정예·보스·방패·성벽 앞 위험 표적에 집중",
        ["처형자", "킬 체인", "처치 시 강화된 후속 미사일로 다음 표적 사냥"],
        [
          "약점 사냥꾼",
          "전술 사냥꾼",
      ...
      tree(
        ...
        [
          "연쇄 추적",
          "연쇄 포식자",
          "처치 후 같은 미사일이 더 강하게 다음 표적 사냥",
        ],
        [
          "재유도",
          "불사조 미사일",
          "적중 후에도 재탐색해 반복 사냥 · 횟수와 수명 제한",
        ],
      ),
    ],
    transcendences: [
    ...
    overclocks: [
      option(
        ...
        "사냥 본능 폭주",
        "⌖",
        "강적 집중 일제사격 · 반복 피해와 추적 성능 강화",
      ),
      option(
        "network",
        "전장 사냥망",
        "⋔",
        "일제사격 발수 추가 · 다수 위험 표적에 분산",
      ),
      option(
        "immortal",
        "불멸 유도체",
        "∞",
        "긴 수명과 다중 재유도 · 적중 후 지속 사냥, 무한 추적 불가",
      ),
    ],
  },
  drone: {
