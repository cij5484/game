...
**Current Source of Truth — M10 다연장 유도미사일 / Missile Salvo**

작성일: 2026-09-18. **목표 설계와 구현·검증 기록을 구분한다.**
기준: [GDD v0.13](GAME_GDD_v0.13.md) 전체 설계·Prototype 기본값·기술 요구·Future·역사 기록을 승계한다. v0.13 원본은 수정하지 않는다. M9 `2b889434b162e01c222c2f42077cb8b2f852687d`는 [PR24](https://github.com/cij5484/game/pull/24) / main `0bcc4fb`로 병합했다. M10은 `codex/prototype-m10-missile-salvo`에서 **commit/push 후 정지**하며 main merge와 다음 Milestone 자동 시작은 하지 않는다.

미사일 최신 설계는 **§1.25 / §2.10 / §3.12**, 실제 구현·검증은 [M10 기록](../prototype-m10-missile-salvo.md)을 따른다. M9의 무기 수치 보존 문구는 M9 당시 범위이며, M10은 미사일만 명시적으로 대체한다. Gauss·Grenade·Drone·Horde·Enemy HP·XP·Relic·Core·Synergy·Boss와 M9 성능 원칙은 유지한다. 과거 단발150/2700ms/속도440 수치는 역사 기록이다.
...
기본 개조6종·3슬롯, 무한 공용/숙련 성장, 독립 희귀도·전설, 특수무기 트리 및 전체 Overclock5종, 대성공, 유물 무레벨/무패널티, High-Variance, Portrait, 스팀팩·고유 Gesture, Reroll 기본0 방향은 유지한다. v0.4/v0.5를 포함한 과거 버전은 역사 문서로 보존하며 상충 시 최신 v0.14를 우선한다.
